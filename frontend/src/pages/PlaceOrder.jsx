      ...
      <div className='mt-8 w-full flex flex-col items-end'>
        ...
        <div className='mt-12 w-full max-w-[320px]'>
          ...
          <div className='flex flex-wrap justify-between gap-4'>
            ...
            <div onClick={()=>setMethod('stripe')} className='flex items-center gap-2 border p-3 rounded cursor-pointer w-full sm:w-[250px]'>
              <p className={`w-4 h-4 border rounded-full ${method === 'stripe' ? 'bg-green-400' : ''}`}></p>
              <img className='h-5 object-contain' src={assets.stripe_logo} alt=""/>
            </div>

            <div onClick={()=>setMethod('razorpay')} className='flex items-center gap-2 border p-3 rounded cursor-pointer w-full sm:w-[250px]'>
              <p className={`w-4 h-4 border rounded-full ${method === 'razorpay' ? 'bg-green-400' : ''}`}></p>
              <img className='h-5 object-contain' src={assets.razorpay_logo} alt=""/>
            </div>

            <div onClick={()=>setMethod('cod')} className='flex items-center gap-2 border p-3 rounded cursor-pointer w-full sm:w-[250px]'>
